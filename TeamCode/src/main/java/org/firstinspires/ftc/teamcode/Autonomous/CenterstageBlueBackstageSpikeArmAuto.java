...
@Autonomous (name = "_CenterstageBlueBackstageSpikeArmAuto")

public class CenterstageBlueBackstageSpikeArmAuto extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        if (opModeIsActive()) {
            ...
            if (spikePos == 1) {
                ...
                motorFrontLeft.setTargetPosition(-250);
                motorBackLeft.setTargetPosition(-250);
                motorFrontRight.setTargetPosition(-250);
                motorBackRight.setTargetPosition(-250);
                intakeMotor.setPower(0);
                pixelClampServo.setPosition(1);
                motorFrontLeft.setMode(DcMotor.RunMode.RUN_TO_POSITION);
                motorBackLeft.setMode(DcMotor.RunMode.RUN_TO_POSITION);
                ...
                motorFrontLeft.setTargetPosition(-770);
                motorBackLeft.setTargetPosition(-770);
                motorFrontRight.setTargetPosition(770);
                motorBackRight.setTargetPosition(770);
                intakeMotor.setPower(0);
                pixelClampServo.setPosition(1);
                motorFrontLeft.setMode(DcMotor.RunMode.RUN_TO_POSITION);
                motorBackLeft.setMode(DcMotor.RunMode.RUN_TO_POSITION);
                ...
                motorFrontLeft.setTargetPosition(-600);
                motorBackLeft.setTargetPosition(-600);
                motorFrontRight.setTargetPosition(630);
                motorBackRight.setTargetPosition(630);
                intakeMotor.setPower(0);
                pixelClampServo.setPosition(1);
                motorFrontLeft.setMode(DcMotor.RunMode.RUN_TO_POSITION);
                motorBackLeft.setMode(DcMotor.RunMode.RUN_TO_POSITION);
